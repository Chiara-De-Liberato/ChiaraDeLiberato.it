...
if(empty($cookie_lang) && $flag == 0){
	if($browser_lang == "it" || $browser_lang == "en" || $browser_lang == "jp"){
		setcookie("chiaradeliberato_lang", $browser_lang, time()+604800, "/","chiaradeliberato.it");
		setcookie("chiaradeliberato_lang", $browser_lang, time()+604800, "/","blog.chiaradeliberato.it");
	...
	if($click_lang == "it" || $click_lang == "en" || $click_lang == "jp"){
		setcookie("chiaradeliberato_lang", $click_lang, time()+604800, "/","chiaradeliberato.it");
		setcookie("chiaradeliberato_lang", $click_lang, time()+604800, "/","blog.chiaradeliberato.it");
